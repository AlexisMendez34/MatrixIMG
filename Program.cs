...
namespace MatrixIMG
{
    class Program
    {
        ...
        {
            //Se debe realizar una función que pueda leer una imagen monocromática y convertirla a una matriz de píxeles, La función debe devolver la matriz de píxeles.
